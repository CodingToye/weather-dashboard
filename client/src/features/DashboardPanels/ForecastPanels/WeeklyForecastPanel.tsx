...
const WeeklyForecastPanel: React.FC<WeeklyForecastPanelProps> = ({
  ...
  return (
    <>
      <Panel dataTestId="weekly-forecast-panel-test" extraClasses="lg:grow">
        <div>
          <Header heading="Weekly Forecast" />
          <div className="flex flex-col gap-2">
            {weeklyForecast.map((day: ForecastDay, index: number) => (
              ...
              >
                ...
                <span className="text-lg text-neutral-darkGrey/75 dark:text-white/75">
                  {Math.round(
